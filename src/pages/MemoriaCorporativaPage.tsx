      ...
      <main className="flex-1 flex flex-col min-h-0 px-4 md:px-6 lg:px-10 pt-4 pb-8 md:pb-16">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="shrink-0">
          ...
          <div className="mb-3 md:mb-5">
            ...
            <h1 className="font-serif text-3xl md:text-5xl font-bold text-foreground leading-tight mb-2">Memoria Corporativa</h1>
            <p className="text-base md:text-xl font-sans text-muted-foreground">De perder conocimiento cada vez que alguien se va a convertir cada transacción en ventaja acumulativa.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-7 shrink-0 lg:auto-rows-fr">
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.4 }}
            ...
            <p className="text-base md:text-lg font-sans text-muted-foreground leading-relaxed mb-4 md:mb-5">La IA permite buscar y recuperar conocimiento de transacciones pasadas en lenguaje natural, como si le preguntaras al socio más experimentado.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.4 }}
            ...
            <p className="text-base md:text-lg font-sans text-muted-foreground leading-relaxed mb-4 md:mb-5">Un sistema que captura, organiza y hace accesible todo el conocimiento de la firma — cada deal cerrado hace a la firma más inteligente.</p>
            <div className="space-y-3 md:space-y-4 flex-1">
