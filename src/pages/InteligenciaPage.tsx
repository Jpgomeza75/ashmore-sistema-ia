      ...
      <main className="flex-1 flex flex-col min-h-0 px-4 md:px-6 lg:px-10 pt-4 pb-8 md:pb-16">
        ...
        >
          ...
          <div className="mb-3 md:mb-5">
            ...
            <h1 className="font-serif text-3xl md:text-5xl font-bold text-foreground leading-tight mb-2">Inteligencia de Mercado</h1>
            <p className="text-base md:text-xl font-sans text-muted-foreground">De revisar noticias manualmente a tener un radar de oportunidades que nunca duerme.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-7 shrink-0 lg:auto-rows-fr">
          ...
          >
            ...
            <p className="text-base md:text-lg font-sans text-muted-foreground leading-relaxed mb-4 md:mb-5">Con herramientas de IA generativa, cada analista se convierte en un radar de mercado de alta frecuencia. No reemplaza el criterio del banquero — lo amplifica, procesando en minutos lo que antes tomaba días.</p>
          ...
          >
            ...
            <p className="text-base md:text-lg font-sans text-muted-foreground leading-relaxed mb-4 md:mb-5">Un sistema institucional que captura, procesa y distribuye inteligencia de mercado automáticamente. La firma tiene un radar encendido 24/7 que alimenta el pipeline comercial sin depender de que alguien se acuerde de revisar las noticias.</p>
            <div className="space-y-3 md:space-y-4 flex-1">
