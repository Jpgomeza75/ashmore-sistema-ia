...
const Index = () => {
  return (
    <div className="min-h-screen md:h-screen flex flex-col md:overflow-hidden bg-background">
      <Header />
      <main className="flex-1 flex flex-col md:overflow-hidden px-4 sm:px-6 lg:px-8 py-2">
        {/* Hero — compact */}
        <motion.div
        ...
        >
          <h1 className="font-serif text-2xl md:text-3xl font-bold text-foreground leading-tight mb-1">
            El Sistema Operativo de la{" "}
            <span className="text-gradient-copper">Banca de Inversión</span>
          </h1>
          <p className="text-xs md:text-sm font-sans text-muted-foreground max-w-xl mx-auto leading-relaxed">
