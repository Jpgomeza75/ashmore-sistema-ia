      ...
      <main className="flex-1 flex flex-col min-h-0 px-6 lg:px-10 pt-4 pb-16">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="shrink-0">
          ...
          <div className="mb-5">
            ...
            <h1 className="font-serif text-5xl font-bold text-foreground leading-tight mb-2">Desarrollo Comercial</h1>
            <p className="text-xl font-sans text-muted-foreground">De esperar que el teléfono suene a tener un motor comercial que genera oportunidades sistemáticamente.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 shrink-0 auto-rows-fr">
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.4 }}
            ...
            <p className="text-lg font-sans text-muted-foreground leading-relaxed mb-5">Cada banquero se convierte en una máquina de generación de propuestas. La IA acelera la investigación, el análisis de fit y la preparación de materiales comerciales.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.4 }}
            ...
            <p className="text-lg font-sans text-muted-foreground leading-relaxed mb-5">Un motor comercial que identifica oportunidades, califica targets, prepara materiales y hace seguimiento automáticamente. La firma tiene pipeline sin depender de que alguien se acuerde.</p>
            <div className="space-y-4 flex-1">
