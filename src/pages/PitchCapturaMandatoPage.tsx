      ...
      <main className="flex-1 flex flex-col min-h-0 px-6 lg:px-10 pt-4 pb-16">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="shrink-0">
          ...
          <div className="mb-5">
            ...
            <h1 className="font-serif text-5xl font-bold text-foreground leading-tight mb-2">Pitch y Captura de Mandato</h1>
            <p className="text-xl font-sans text-muted-foreground">De preparar pitches genéricos a llegar con propuestas que demuestran que ya hiciste el trabajo.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 shrink-0 auto-rows-fr">
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.4 }}
            ...
            <p className="text-lg font-sans text-muted-foreground leading-relaxed mb-5">La IA elimina las horas de investigación y formateo para que el equipo se concentre en la estrategia y la narrativa que gana mandatos.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.4 }}
            ...
            <p className="text-lg font-sans text-muted-foreground leading-relaxed mb-5">Un sistema que aprende de cada pitch — qué funcionó, qué no, qué preguntas hicieron — y usa ese conocimiento para mejorar los siguientes.</p>
            <div className="space-y-4 flex-1">
