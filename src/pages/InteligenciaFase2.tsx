    ...
    <div className="h-screen flex flex-col overflow-hidden bg-background">
      ...
      <main className="flex-1 flex flex-col min-h-0 px-6 lg:px-10 pt-4 pb-16">
        ...
        >
          ...
          <p className="text-lg font-sans text-muted-foreground max-w-4xl">
            Un radar permanente que encuentra oportunidades, las califica y las pone en el escritorio del banquero correcto. Sin depender de que alguien se acuerde de revisar las noticias.
          </p>
        </motion.div>

        {/* Main Content */}
        <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[38%_62%] gap-6">
          {/* Left: Motor Cards */}
          <motion.div
          ...
          >
            <h2 className="font-serif text-2xl font-bold text-foreground mb-3">Motores de Inteligencia</h2>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="flex flex-col min-h-0 overflow-y-auto pr-1"
            >
              {/* Standalone Block */}
              <div className="mb-4">
                ...
                <h3 className="font-serif text-2xl font-bold text-foreground mb-1">{motor.name}</h3>
                <p className="text-base font-sans text-muted-foreground leading-relaxed mb-4">{motor.standalone.description}</p>
                <div className="space-y-3">
                  {motor.standalone.capabilities.map((cap, i) => (
                    <div key={i}>
                      <span className="text-[15px] font-sans font-bold text-copper">{cap.title}</span>
                      <p className="text-sm font-sans text-muted-foreground leading-snug mt-0.5">{cap.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="rounded-lg border p-5"
                ...
                <h3 className="font-serif text-xl font-bold text-copper mb-1">Con el sistema completo</h3>
                <p className="text-base font-sans text-muted-foreground leading-relaxed mb-4">{motor.connected.description}</p>
        ...
        >
          <div className="text-center mb-3">
            <p className="text-lg font-sans font-bold text-copper leading-snug">
