      ...
      <main className="flex-1 flex flex-col min-h-0 px-4 md:px-6 lg:px-10 pt-4 pb-8 md:pb-16">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="shrink-0">
          ...
          <div className="mb-3 md:mb-5">
            ...
            <h1 className="font-serif text-3xl md:text-5xl font-bold text-foreground leading-tight mb-2">Control de Calidad y Gobernanza</h1>
            <p className="text-base md:text-xl font-sans text-muted-foreground">De depender del ojo del socio a tener estándares que se aplican automáticamente.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-7 shrink-0 lg:auto-rows-fr">
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.4 }}
            ...
            <p className="text-base md:text-lg font-sans text-muted-foreground leading-relaxed mb-4 md:mb-5">La IA actúa como primer filtro de calidad: revisa modelos, valida documentos y detecta inconsistencias antes de que lleguen al socio.</p>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.4 }}
            ...
            <p className="text-base md:text-lg font-sans text-muted-foreground leading-relaxed mb-4 md:mb-5">Un sistema de gobernanza que asegura que todo entregable cumple los estándares de la firma, con trazabilidad completa y mejora continua.</p>
            <div className="space-y-3 md:space-y-4 flex-1">
